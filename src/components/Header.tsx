          ...
          {currentUser ? (
            <div className="flex items-center gap-3">
              <div className="text-right bg-gradient-to-r from-primary/15 to-accent/20 px-4 py-3 rounded-xl border border-primary/30 shadow-elegant hover:shadow-glow transition-all duration-300 backdrop-blur-sm">
                <div className="font-bold text-primary text-lg">{currentUser.name}</div>
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="border-primary/30 text-primary hover:bg-primary/20 hover:text-primary font-semibold shadow-sm hover:shadow-md transition-all duration-300 bg-gradient-to-r from-primary/5 to-accent/10"
              >
                {t("Sign Out", "সাইন আউট")}
              </Button>
            </div>
