      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-white/20 text-white px-4 py-2 rounded-full text-sm font-medium mb-8">
            ...
            <span className="text-bengali">আজই শুরু করুন - সম্পূর্ণ বিনামূল্যে</span>
          </div>

          {/* Heading */}
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 text-bengali">
            এখনই অংশ হোন আমাদের স্বপ্নের
          ...
          {/* Description */}
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto text-bengali">
            দক্ষিণ এশিয়া থেকে সারা বিশ্ব — আমরা সবাইকে একত্রিত করতে চাই। 
            আপনার অংশগ্রহণ আমাদের স্বপ্নকে বাস্তব করতে সাহায্য করবে।
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            >
              <span className="text-bengali">আমাদের মিশন জানুন</span>
            </Button>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="flex items-center gap-2 text-white/80">
              ...
              <span className="text-bengali">১৫+ দেশ থেকে</span>
            </div>
            <div className="flex items-center gap-2 text-white/80">
              <Sparkles className="w-5 h-5" />
              <span className="text-bengali">১০০% বিনামূল্যে</span>
            </div>
          </div>
        </div>
      </div>
