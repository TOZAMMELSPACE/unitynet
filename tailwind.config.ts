  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        'sans': ['DM Sans', 'Noto Sans Bengali', 'ui-sans-serif', 'system-ui', 'sans-serif'],
      },
      colors: {
      ...
      boxShadow: {
        ...
        'elegant': '0 2px 8px -2px rgba(0, 0, 0, 0.08), 0 4px 16px -4px rgba(0, 0, 0, 0.06)',
        'glow': '0 0 40px rgba(45, 140, 135, 0.12)',
      },
      borderRadius: {
        lg: "var(--radius)",
